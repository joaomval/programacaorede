...
public class ComentarioArtigo {
     ...
     public String devolveComentarioArtigoPorId(HttpServletRequest request, HttpServletResponse response) throws Exception {
        Teste_Acesso_BD bd = new Teste_Acesso_BD();
        bd.carregaDriverEAbreConnection();
        bd.abreStatement();
        Hashtable params = new Hashtable();
        params.put("var_id", request.getParameter("var_id"));
        String qryName = new String("devolve_comentario_artigo_por_id");
        ResultSet rs;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("Comentario Artigo@@@@@@@: " + comentario);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        } finally {
    ...
    public void insere(final Hashtable<String, Object> params) {
        ...
        bd.carregaDriverEAbreConnection();
        bd.abreStatement();
        String qryName = new String("insere_comentario_artigo");
        try {
    ...
    public void apaga(final Hashtable<String, Object> params) {
        ...
        bd.carregaDriverEAbreConnection();
        bd.abreStatement();
        String qryName = new String("apaga_comentario_artigo");
        try {
            bd.executaUpdate(qryName, params);
        } catch (Exception ex) {
            ex.printStackTrace();
